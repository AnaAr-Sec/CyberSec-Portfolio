...
* **🛡️ Cisco Certified Support Technician (CCST) Cybersecurity**
* **🐍 Python Essentials 1** | Python Institute (En progreso)
* **🔐 Network Security Fundamentals** | Palo Alto (En progreso)
...
- Administración segura de información confidencial
- Gestión documental para auditorías
- Trazabilidad de evidencias de cumplimiento

### ⚒️ Laboratorios Técnicos (Próximamente)
Actualmente estoy desarrollando laboratorios prácticos de ciberseguridad:

- Simulación de redes seguras en Cisco Packet Tracer
- Automatización básica de tareas de seguridad con Python
- Análisis de riesgos de seguridad en infraestructuras de red
